...
public class RemindersActivity extends AppCompatActivity implements ActionMode.Callback, ReminderInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reminderRecyclerView = findViewById(R.id.reminders_recycler_view);
    ...
    private void openEditDialog(int reminderPosition){
        ...
        ReminderFSD editReminderFSD =  ReminderFSD.

        newInstance(reminderId,reminderTitle,reminderDOF,reminderTOF,reminderTIM,reminderPosition,true);
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.ra_action_copy:
                ...
                Snackbar.make(rARootLayout,rACopyConfirmationText,Snackbar.
    ...
    protected void shareApp(){
        ...
        sAIntent.putExtra(Intent.

        EXTRA_TEXT,"Reminder App is a fast and simple app that I use to schedule tasks. Get it from: https://play.google.com/store/apps/details?id="+getPackageName());
