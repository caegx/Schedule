...
public class ReminderAdapter extends RecyclerView.Adapter<ReminderAdapter.ReminderViewHolder>{
    ...
    private final Context reminderAdapterContext;
    ...
    protected class ReminderViewHolder extends RecyclerView.ViewHolder {
        ...
        public ReminderViewHolder(View view) {
            super(view);
            rTitleTextView = view.findViewById(R.id.reminder_title_tvw);
            rTOFTextView = view.findViewById(R.id.reminder_tof_tvw);
